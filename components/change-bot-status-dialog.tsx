    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Êtes-vous sûr de vouloir changer le statut de la bot transaction : <span className="font-mono font-semibold">{transaction?.reference}</span> ?
          </DialogDescription>
        </DialogHeader>
...
interface BotTransactionStatusDialogProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  statusData: any
  isLoading: boolean
...
export function BotTransactionStatusDialog({ open, onOpenChange, statusData, isLoading }: BotTransactionStatusDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Statut de la Transaction Bot</DialogTitle>
